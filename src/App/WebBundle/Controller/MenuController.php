...
use App\WebBundle\Form\MenuType;
...
class MenuController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppWebBundle:Menu')->findAll();
     ...
     * @Method("POST")
     * @Template("AppWebBundle:Menu:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppWebBundle:Menu')->find($id);
     ...
     * @Method("PUT")
     * @Template("AppWebBundle:Menu:edit.html.twig")
     */
